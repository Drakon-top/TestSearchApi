...
curl -L -o archive.tar.gz https://github.com/drakon-top/TestSearchApi/raw/main/tests.tar.gz && tar -xf archive.tar.gz && cd archive_test && THREADS_COUNT=5 REQUESTS_COUNT=250 SEARCH_API_KEY=AQVNXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX SEARCH_API_FOLDERID=b1gk4c5mob13sqnm4g7l bash run_all.sh > output.txt && cat output.txt
```
